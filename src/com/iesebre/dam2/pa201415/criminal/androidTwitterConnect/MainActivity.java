package com.iesebre.dam2.pa201415.criminal.androidTwitterConnect;
...
import com.iesebre.dam2.pa201415.criminal.androidTwitterConnect.R;
...
public class MainActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		 ...
		 * Verifier
		 * */
		Log.d("Logout","Antes del if de comprobación del twitter");
		if (!isTwitterLoggedInAlready()) {
			Log.d("Logout","Es false");
	...
	class updateTwitterStatus extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			Log.d("Logout","clase updateTwitterStatus metodo onPreExecute");
			super.onPreExecute();
		...
		protected String doInBackground(String... args) {
			Log.d("Logout","funcion doInBackground");
		...
		protected void onPostExecute(String file_url) {
			Log.d("Logout","clase updateTwitterStatus funcion onPostExecute");
